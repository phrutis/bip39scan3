...
Vulnerable generator libbitcoin explorer v3.2 - GPUs brute.<br>
...
```-l ko``` Korean phrases (will be)<br>
```-l po``` Portuguese phrases (will be)<br>
```-l tu``` Turkish phrases (will be)<br>
